...
if [[ "$1" == "help" || "$1" == "--help" ||"$1" == "-h" || -z "$1" ]]; then
  echo "DEFAULT USAGE: '$0 change-password PASS NEWPASS [\"profile1 profile2 profile3\"]'
  in case you provide 'generate' keyword as a NEWPASS - your password will be autogenerated.
